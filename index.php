                ...
                if ($firstname == "" || $email == "" || $password == "" || $lastname =="" || $phone == "") {
                    ...
                    if ($password == $cpassword) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            $sql_insert = "INSERT INTO signup (Email, Password, firstname, lastname, phone) VALUES (?, ?, ?, ?, ?)";
                            $stmt_insert = prepareAndExecute($conn, $sql_insert, [$email, $password, $firstname, $lastname, $phone]);
